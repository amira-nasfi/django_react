...
SECRET_KEY = 'django-insecure-dd63-v8eoj6i50p7!l^)hv2u90i51pi9dlzw%tl*^cjmi*s=oq'
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API conforme HL7 FHIR — 10 ressources FHIR R4',
    'VERSION': '1.0.0',
    'SECURITY': [{'jwtAuth': []}],
    'APPEND_COMPONENTS': {
        'securitySchemes': {
...
# Make JWT tokens infinite (never expire)
